...
function FieldLabel({ className, ...props }: React.ComponentProps<'label'>): React.JSX.Element { return <Label data-slot="field-label" className={cn('text-sm font-medium leading-none', className)} {...props} />; }
...
function FieldLegend({ className, ...props }: React.ComponentProps<'legend'>): React.JSX.Element { return <Fieldset.Legend data-slot="field-legend" className={cn('mb-2 text-base font-semibold', className)} {...props} />; }
