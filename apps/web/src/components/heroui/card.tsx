...
function Card({ className, ...props }: DivProps): React.JSX.Element { return <HeroUICard className={cn('gap-6 rounded-xl border border-border bg-card py-6 text-card-foreground shadow-none', className)} {...props} />; }
